...
| 算法 | 演示 | 平均长度 | 最大长度 |
|:------:|:------:|:--------:|:--------:|
| **GRPO 算法** | <img src="docs/grpo_demo.gif" alt="grpo_demo" width="80%" /> | 12.038 | 26 |
| **Double DQN 算法** | <img src="docs/dqn_demo.gif" alt="dqn_demo" width="80%" /> | 12.151 | 22 |
| **PPO 算法** | <img src="docs/ppo_demo.gif" alt="ppo_demo" width="80%" /> | 11.653 | 20 |
